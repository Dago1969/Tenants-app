...
const EQUIPMENT_MODULE_CODE = 'EQUIPMENT';
const EQUIPMENT_TYPE_MODULE_CODE = 'EQUIPMENT_TYPE';
...
const MODULE_TITLE_KEYS: Record<string, MessageKey> = {
  ...
  DOCTOR: 'menu.doctors',
  NURSE: 'menu.nurses',
  THERAPEUTIC_PLAN: 'menu.therapeuticPlans',
  [EQUIPMENT_MODULE_CODE]: 'menu.equipmentSearch',
  [EQUIPMENT_TYPE_MODULE_CODE]: 'menu.equipmentTypesSearch',
...
const MODULE_MESSAGE_PREFIXES: Record<string, string> = {
  ...
  [EQUIPMENT_MODULE_CODE]: 'equipment',
  [EQUIPMENT_TYPE_MODULE_CODE]: 'equipment.types',

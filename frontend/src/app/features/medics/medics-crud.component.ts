...
export class MedicsCrudComponent {
  ...
  fields: CrudField[] = [
    ...
    { key: 'region', labelKey: 'medics.field.region', type: 'text', hidden: true },
    {
      key: 'provinceId',
      labelKey: 'medics.field.province',
      type: 'select',
    ...
    { key: 'province', labelKey: 'medics.field.province', type: 'text', hidden: true },
    {
      key: 'cityId',
      labelKey: 'medics.field.city',
      type: 'select',
    ...
    { key: 'city', labelKey: 'medics.field.city', type: 'text', hidden: true },

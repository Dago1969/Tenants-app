...
export const appRoutes: Routes = [
  ...
  { path: 'structure-types/search', component: StructureTypesSearchComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.GENERIC)] },
  { path: 'structure-types/manage', component: StructureTypesCrudComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.GENERIC)] },
  { path: 'structure-types/manage/:code', component: StructureTypesCrudComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.GENERIC)] },
  { path: 'structures', pathMatch: 'full', redirectTo: 'structures/asl' },
  { path: 'structures/asl', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.ASL)], data: { structureType: 'ASL', moduleCode: STRUCTURE_MODULE_CODES.ASL, titleKey: 'structures.type.asl.search.title', manageRoute: '/structures/asl/manage' } },
  ...
  { path: 'structures/hospital-pharmacies/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.HOSPITAL_PHARMACY)], data: { structureType: 'HOSPITAL_PHARMACY', titleKey: 'structures.type.hospitalPharmacy.title' } },
  { path: 'structures/hospital-pharmacies/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.HOSPITAL_PHARMACY)], data: { structureType: 'HOSPITAL_PHARMACY', titleKey: 'structures.type.hospitalPharmacy.title' } },
  { path: 'structures/retail-pharmacies', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.RETAIL_PHARMACY)], data: { structureType: 'RETAIL_PHARMACY', moduleCode: STRUCTURE_MODULE_CODES.RETAIL_PHARMACY, titleKey: 'structures.type.retailPharmacy.search.title', manageRoute: '/structures/retail-pharmacies/manage' } },
  { path: 'structures/retail-pharmacies/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.RETAIL_PHARMACY)], data: { structureType: 'RETAIL_PHARMACY', titleKey: 'structures.type.retailPharmacy.title' } },
  { path: 'structures/retail-pharmacies/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.RETAIL_PHARMACY)], data: { structureType: 'RETAIL_PHARMACY', titleKey: 'structures.type.retailPharmacy.title' } },
  { path: 'structures/logistics-warehouses', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.LOGISTICS_WAREHOUSE)], data: { structureType: 'LOGISTICS_WAREHOUSE', moduleCode: STRUCTURE_MODULE_CODES.LOGISTICS_WAREHOUSE, titleKey: 'structures.type.logisticsWarehouse.search.title', manageRoute: '/structures/logistics-warehouses/manage' } },
  { path: 'structures/logistics-warehouses/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.LOGISTICS_WAREHOUSE)], data: { structureType: 'LOGISTICS_WAREHOUSE', titleKey: 'structures.type.logisticsWarehouse.title' } },
  { path: 'structures/logistics-warehouses/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.LOGISTICS_WAREHOUSE)], data: { structureType: 'LOGISTICS_WAREHOUSE', titleKey: 'structures.type.logisticsWarehouse.title' } },
  { path: 'structures/material-warehouses', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.MATERIAL_WAREHOUSE)], data: { structureType: 'MATERIAL_WAREHOUSE', moduleCode: STRUCTURE_MODULE_CODES.MATERIAL_WAREHOUSE, titleKey: 'structures.type.materialWarehouse.search.title', manageRoute: '/structures/material-warehouses/manage' } },
  { path: 'structures/material-warehouses/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.MATERIAL_WAREHOUSE)], data: { structureType: 'MATERIAL_WAREHOUSE', titleKey: 'structures.type.materialWarehouse.title' } },
  { path: 'structures/material-warehouses/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.MATERIAL_WAREHOUSE)], data: { structureType: 'MATERIAL_WAREHOUSE', titleKey: 'structures.type.materialWarehouse.title' } },
  { path: 'structures/pharma-companies', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.PHARMA_COMPANY)], data: { structureType: 'PHARMA_COMPANY', moduleCode: STRUCTURE_MODULE_CODES.PHARMA_COMPANY, titleKey: 'structures.type.pharmaCompany.search.title', manageRoute: '/structures/pharma-companies/manage' } },
  { path: 'structures/pharma-companies/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.PHARMA_COMPANY)], data: { structureType: 'PHARMA_COMPANY', titleKey: 'structures.type.pharmaCompany.title' } },
  { path: 'structures/pharma-companies/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.PHARMA_COMPANY)], data: { structureType: 'PHARMA_COMPANY', titleKey: 'structures.type.pharmaCompany.title' } },
  { path: 'structures/specialist-clinics', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.SPECIALIST_CLINIC)], data: { structureType: 'SPECIALIST_CLINIC', moduleCode: STRUCTURE_MODULE_CODES.SPECIALIST_CLINIC, titleKey: 'structures.type.specialistClinic.search.title', manageRoute: '/structures/specialist-clinics/manage' } },
  { path: 'structures/specialist-clinics/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.SPECIALIST_CLINIC)], data: { structureType: 'SPECIALIST_CLINIC', titleKey: 'structures.type.specialistClinic.title' } },
  { path: 'structures/specialist-clinics/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard(STRUCTURE_MODULE_CODES.SPECIALIST_CLINIC)], data: { structureType: 'SPECIALIST_CLINIC', titleKey: 'structures.type.specialistClinic.title' } },

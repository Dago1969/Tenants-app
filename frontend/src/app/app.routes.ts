...
export const appRoutes: Routes = [
  ...
  { path: 'structures/asl', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-ASL')], data: { structureType: 'ASL', moduleCode: 'STRUCTURE-ASL', titleKey: 'structures.type.asl.search.title', manageRoute: '/structures/asl/manage' } },
  { path: 'structures/asl/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-ASL')], data: { structureType: 'ASL', titleKey: 'structures.type.asl.title' } },
  { path: 'structures/asl/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-ASL')], data: { structureType: 'ASL', titleKey: 'structures.type.asl.title' } },
  { path: 'structures/hospitals', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('HOSPITAL')], data: { structureType: 'HOSPITAL', moduleCode: 'HOSPITAL', titleKey: 'structures.type.hospital.search.title', manageRoute: '/structures/hospitals/manage' } },
  { path: 'structures/hospitals/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('HOSPITAL')], data: { structureType: 'HOSPITAL', titleKey: 'structures.type.hospital.title' } },
  { path: 'structures/hospitals/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('HOSPITAL')], data: { structureType: 'HOSPITAL', titleKey: 'structures.type.hospital.title' } },
  { path: 'structures/hospital-pharmacies', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-FARMACY-O')], data: { structureType: 'HOSPITAL_PHARMACY', moduleCode: 'STRUCTURE-FARMACY-O', titleKey: 'structures.type.hospitalPharmacy.search.title', manageRoute: '/structures/hospital-pharmacies/manage' } },
  { path: 'structures/hospital-pharmacies/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-FARMACY-O')], data: { structureType: 'HOSPITAL_PHARMACY', titleKey: 'structures.type.hospitalPharmacy.title' } },
  { path: 'structures/hospital-pharmacies/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-FARMACY-O')], data: { structureType: 'HOSPITAL_PHARMACY', titleKey: 'structures.type.hospitalPharmacy.title' } },
  { path: 'structures/retail-pharmacies', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-FARMACY-R')], data: { structureType: 'RETAIL_PHARMACY', moduleCode: 'STRUCTURE-FARMACY-R', titleKey: 'structures.type.retailPharmacy.search.title', manageRoute: '/structures/retail-pharmacies/manage' } },
  { path: 'structures/retail-pharmacies/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-FARMACY-R')], data: { structureType: 'RETAIL_PHARMACY', titleKey: 'structures.type.retailPharmacy.title' } },
  { path: 'structures/retail-pharmacies/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE-FARMACY-R')], data: { structureType: 'RETAIL_PHARMACY', titleKey: 'structures.type.retailPharmacy.title' } },
  { path: 'structures/logistics-warehouses', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_LOGISTICS_WAREHOUSE')], data: { structureType: 'LOGISTICS_WAREHOUSE', moduleCode: 'STRUCTURE_LOGISTICS_WAREHOUSE', titleKey: 'structures.type.logisticsWarehouse.search.title', manageRoute: '/structures/logistics-warehouses/manage' } },
  { path: 'structures/logistics-warehouses/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_LOGISTICS_WAREHOUSE')], data: { structureType: 'LOGISTICS_WAREHOUSE', titleKey: 'structures.type.logisticsWarehouse.title' } },
  { path: 'structures/logistics-warehouses/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_LOGISTICS_WAREHOUSE')], data: { structureType: 'LOGISTICS_WAREHOUSE', titleKey: 'structures.type.logisticsWarehouse.title' } },
  { path: 'structures/material-warehouses', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_MATERIAL_WAREHOUSE')], data: { structureType: 'MATERIAL_WAREHOUSE', moduleCode: 'STRUCTURE_MATERIAL_WAREHOUSE', titleKey: 'structures.type.materialWarehouse.search.title', manageRoute: '/structures/material-warehouses/manage' } },
  { path: 'structures/material-warehouses/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_MATERIAL_WAREHOUSE')], data: { structureType: 'MATERIAL_WAREHOUSE', titleKey: 'structures.type.materialWarehouse.title' } },
  { path: 'structures/material-warehouses/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_MATERIAL_WAREHOUSE')], data: { structureType: 'MATERIAL_WAREHOUSE', titleKey: 'structures.type.materialWarehouse.title' } },
  { path: 'structures/pharma-companies', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_PHARMA_COMPANY')], data: { structureType: 'PHARMA_COMPANY', moduleCode: 'STRUCTURE_PHARMA_COMPANY', titleKey: 'structures.type.pharmaCompany.search.title', manageRoute: '/structures/pharma-companies/manage' } },
  { path: 'structures/pharma-companies/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_PHARMA_COMPANY')], data: { structureType: 'PHARMA_COMPANY', titleKey: 'structures.type.pharmaCompany.title' } },
  { path: 'structures/pharma-companies/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_PHARMA_COMPANY')], data: { structureType: 'PHARMA_COMPANY', titleKey: 'structures.type.pharmaCompany.title' } },
  { path: 'structures/specialist-clinics', component: StructureSearchComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_SPECIALIST_CLINIC')], data: { structureType: 'SPECIALIST_CLINIC', moduleCode: 'STRUCTURE_SPECIALIST_CLINIC', titleKey: 'structures.type.specialistClinic.search.title', manageRoute: '/structures/specialist-clinics/manage' } },
  { path: 'structures/specialist-clinics/manage', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_SPECIALIST_CLINIC')], data: { structureType: 'SPECIALIST_CLINIC', titleKey: 'structures.type.specialistClinic.title' } },
  { path: 'structures/specialist-clinics/manage/:id', component: StructureCatalogComponent, canActivate: [authGuard, moduleVisibilityGuard('STRUCTURE_SPECIALIST_CLINIC')], data: { structureType: 'SPECIALIST_CLINIC', titleKey: 'structures.type.specialistClinic.title' } },

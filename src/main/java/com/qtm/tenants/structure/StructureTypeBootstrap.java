...
public class StructureTypeBootstrap implements CommandLineRunner {
    ...
    private static final List<SeedStructureType> DEFAULT_TYPES = List.of(
            ...
            new SeedStructureType("TERRITORIAL_PHARMACY", "Farmacia Territoriale", "Farmacia territoriale collegata ad una ASL; punto di distribuzione e ritiro locale.", "ASL", 35),
            new SeedStructureType("RETAIL_PHARMACY", "Farmacia Retail", "Punto di ritiro di prossimita o ultimo-miglio delivery nei progetti territoriali.", null, 40),
